...
- Add a Connectivity status badge to the spacetimedb on the webapp. use periodic 5 second ping to update the status. if connection is lost (17 seconds with no ping), block the whole webapp screen and show a "Reconnecting..." message.
